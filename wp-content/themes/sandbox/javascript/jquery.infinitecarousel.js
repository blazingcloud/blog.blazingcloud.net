    ...
    $.fn.extend({
        infiniteCarousel: function(options)
        {
            ...
            return this.each(function() {
                ...
                $('p', obj).hide(); // Hide any text paragraphs in the infinite_carousel
                ...
                $('ul', obj).css('left', '-300px').width(9999);
                ...
                //build overlay div that is 200 px wide, 100% of height of the infinite_carousel, and append to both sides.
                ...
                function moveRight(dist)
                {
                    ...
                    $('li:gt(' + (numImages - (dist + 1)) + ')', obj).remove();
...
console.log("moveRight " + $('ul', obj).children('li'));
                }
